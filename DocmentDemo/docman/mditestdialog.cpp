...
void CMDITestDialog::OnAppopendocButton() 
{
 //   static TCHAR pData1[] = _T("C:\\Users\\XPS_LT\\Documents\\test1.dwg");
	...
	//Acad::ErrorStatus st1 = acDocManager->appContextOpenDocument((const TCHAR *)pData1);
	//Acad::ErrorStatus st2 = acDocManager->appContextOpenDocument((const TCHAR *)pData2);
	//Acad::ErrorStatus st3 = acDocManager->appContextOpenDocument((const TCHAR *)pData3);
